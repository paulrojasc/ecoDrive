...
ActiveRecord::Schema[7.0].define(version: 2023_10_27_102050) do
  ...
  create_table "cars", force: :cascade do |t|
    ...
    t.bigint "modelcar_id", null: false
    ...
    t.index ["modelcar_id"], name: "index_cars_on_modelcar_id"
  ...
  create_table "modelcars", force: :cascade do |t|
    t.string "name"
    t.boolean "available"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "cars", "modelcars"
